...
parser.add_argument('--unified_graph', type=bool, default=False, help='Decide whether takes MTE as initialization on '
                                                                      'graph')
parser.add_argument('--metrics', type=str, default='MSE', help='Either MSE or MAE')
...
def main(ref_date, fct_date, train_window, forecasting_window):
    ...
    for iter_index in range(0, 10):
        ...
        best_model_path = '{}/best_model_CESGCN_LR_{}_{}_quantile_{}_dim_{}_onego_{}_epochs_{}_weight_decay_{}_{}.pth'.format(repo_path, args.lr, ref_date, args.dropout_rate, args.node_dim, args.epochs,
        ...
        quantiled_version.to_csv(
            '{}/CESGCN_LR_{}_{}_quantile_{}_dim_{}_onego_{}_epochs_{}_weight_decay_{}_TRAIN_{}.csv'.
            format(ref_date, args.lr, ref_date, args.dropout_rate, args.node_dim,
                   args.epochs, metric, args.weight_decay, args.version), header=True, index=False, mode='w')

        fct.to_csv(
            '{}/CESGCN_LR_{}_{}_{}_dim_{}_onego_{}_{}_weight_decay_{}_TRAIN_{}.csv'.format(ref_date, args.lr, ref_date,
                                                                                           args.dropout_rate,
                                                                                           args.node_dim,
                                                                                           args.epochs, metric,
                                                                                           args.weight_decay,
