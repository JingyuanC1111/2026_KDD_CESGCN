...
52 is number of regions: states in the US, we use 0-51 as the index for regions.

For example, [8, 12, 0, 1] = 0.1 represents 0[8] has an influence on 1[12] with a weight with magnitude of 0.1
