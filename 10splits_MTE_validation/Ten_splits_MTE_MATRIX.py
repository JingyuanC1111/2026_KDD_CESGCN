...
if __name__ == '__main__':
    ...
    strats = ['MTE_repeat_10_ALLTIME_for_seeding_importedJFK-tau_low-surveil_yes',
              'MTE_repeat_10_ALLTIME_for_seeding_importedJFK-tau_low-surveil_no',
              'MTE_repeat_10_ALLTIME_for_seeding_importedJFK-tau_high-surveil_yes',
              'MTE_repeat_10_ALLTIME_for_seeding_emergingID-tau_low-surveil_no',
              'MTE_repeat_10_ALLTIME_for_seeding_emergingID-tau_high-surveil_yes',
              'MTE_repeat_10_ALLTIME_for_seeding_emergingID-tau_high-surveil_no',
              'MTE_repeat_10_ALLTIME_for_seeding_importedJFK-tau_high-surveil_no',
              'MTE_repeat_10_ALLTIME_for_seeding_emergingID-tau_low-surveil_yes']
    all_ten_splits = list()
    for strat in strats:
        MTE_static_matrices = torch.zeros((28, 28, 49, 49))
        with open('{}'.format(strat), 'rb') as file:
        ...
        MTE_static_matrix_each_split = MTE_static_matrices[-5:,-1,:,:]
        all_ten_splits.append(MTE_static_matrix_each_split)
    np.save('Ten_splits.npy', all_ten_splits)
