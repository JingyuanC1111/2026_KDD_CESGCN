...
def main(ref_date, fct_date, train_window, forecasting_window):
    df = pd.read_csv('CDC_DATA/target-hospital-admissions_0308.csv')
    removable = ['US']
    ...
    for iter_index in range(0,10):
        ...
        quantiled_version.to_csv('0315/CESGCN_LR_{}_{}_quantile_{}_dim_{}_onego_{}_epochs_MSE_weight_decay_{}_PREDICT_{}.csv'.
        ...
        fct.to_csv('0315/CESGCN_LR_{}_{}_{}_dim_{}_onego_{}_MSE_weight_decay_{}_PREDICT_{}.csv'.format(args.lr,ref_date, args.dropout_rate,args.node_dim,args.epochs,args.weight_decay,args.version), header=True, index=False, mode='w')
