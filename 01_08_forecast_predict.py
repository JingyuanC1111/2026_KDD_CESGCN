...
def main(ref_date, fct_date, train_window, forecasting_window):
    ...
    for iter_index in range(0, 10):
        ...
        for metric in metrics:
            ...
            best_model_path = '0104/best_model_0104_CESGCN_LR_0.02_2025-01-04_quantile_0.2_dim_20_onego_100_epochs_MSE_weight_decay_0.02_V9_selected.pth'
            '''
            count_patience = 0
        ...
        quantiled_version.to_csv(
            '0111/CESGCN_LR_{}_{}_quantile_{}_dim_{}_onego_{}_epochs_MSE_weight_decay_{}_PREDICT_{}.csv'.format(args.lr,
                                                                                                                ref_date,
                                                                                                                args.dropout_rate,
                                                                                                                args.node_dim,
                                                                                                                args.epochs,
        ...
        fct.to_csv(
            '0111/CESGCN_LR_{}_{}_{}_dim_{}_onego_{}_MSE_weight_decay_{}_PREDICT_{}.csv'.format(args.lr, ref_date,
                                                                                                args.dropout_rate,
                                                                                                args.node_dim,
                                                                                                args.epochs,
                                                                                                args.weight_decay,
