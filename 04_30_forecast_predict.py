...
def main(ref_date, fct_date, train_window, forecasting_window):
    df = pd.read_csv('CDC_DATA/target-hospital-admissions_0426.csv')
    removable = ['US']
    ...
    # available_data.to_csv('CDC_DATA/transferred_hospital_admission_0426.csv')
    scaler = MinMaxScaler()
    ...
    for iter_index in range(0,10):
        ...
        for metric in metrics:
            ...
            best_model_path = '0208/best_model_0208_CESGCN_LR_0.02_2025-02-08_quantile_0.2_dim_20_onego_100_epochs_MSE_weight_decay_0.02_V1.pth'
            best_model_path = '0301/best_model_0301_CESGCN_LR_0.02_2025-03-01_quantile_0.2_dim_20_onego_100_epochs_MSE_weight_decay_0.02_V5_SELECTED.pth'
            best_model_path = '0329/best_model_0329_CESGCN_LR_0.02_2025-03-22_quantile_0.2_dim_20_onego_100_epochs_MSE_weight_decay_0.02_V3.pth'
            best_model_path = '0412/best_model_0329_CESGCN_LR_0.02_2025-04-05_quantile_0.2_dim_20_onego_100_epochs_MSE_weight_decay_0.02_V6.pth'
            best_model_path = '0419/best_model_0419_CESGCN_LR_0.02_2025-04-12_quantile_0.2_dim_12_onego_100_epochs_MSE_weight_decay_0.02_V5.pth'
            # best_model_path = 'forecasting_result/0102_models/best_model_0102_CESGCN_LR_0.02_2025-01-04_quantile_0
            # .2_dim_12_onego_100_epochs_MSE_weight_decay_0.01_LATEST_V2.pth'
            '''
            count_patience = 0
        ...
        quantiled_version.to_csv('0503/CESGCN_LR_{}_{}_quantile_{}_dim_{}_onego_{}_epochs_MSE_weight_decay_{}_PREDICT_{}.csv'.
        ...
        fct.to_csv('0503/CESGCN_LR_{}_{}_{}_dim_{}_onego_{}_MSE_weight_decay_{}_PREDICT_{}.csv'.format(args.lr,ref_date, args.dropout_rate,args.node_dim,args.epochs,args.weight_decay,args.version), header=True, index=False, mode='w')
