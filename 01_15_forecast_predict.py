...
parser.add_argument('--version', type=str, default='US2')
...
def main(ref_date, fct_date, train_window, forecasting_window):
    df = pd.read_csv('CDC_DATA/target-hospital-admissions_0111.csv')
    # removable = ['US']
    ...
    available_data.to_csv('CDC_DATA/transferred_hospital_admission_0111_w_US.csv')
    scaler = MinMaxScaler()
